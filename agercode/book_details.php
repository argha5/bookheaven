...
if ($book_id > 0) {
    ...
    if ($book) {
        ...
        // Fetch reviews
        $stmt = $conn->prepare("
            SELECT r.*, u.username, u.user_profile 
            FROM reviews r
        ...
        $stmt = $conn->prepare("
           SELECT q.*, u.username as questioner_name, u.user_profile  as questioner_image,
                            ...
                            <?php foreach ($reviews as $review): ?>
                                <div class="review-item">
                                    <div class="review-header">
                                        <img src="/BookHeaven2.0/<?php echo htmlspecialchars($review['user_profile'] ?? 'https://randomuser.me/api/portraits/women/43.jpg'); ?>"
