...
<body>
    ...
    <main>
        ...
        <div class="still-questions">
            ...
            <a href="contact.php"><button style="background-color: var(--primary-color); color: white; border: none; padding: 0.75rem 1.5rem; border-radius: 5px; cursor: pointer; margin-top: 1rem;">Contact Us</button></a>
        </div>
    </main>
